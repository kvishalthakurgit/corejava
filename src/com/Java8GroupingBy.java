...
public class Java8GroupingBy {
	...
	public void groupbyTest(){
		List<Transaction> trans = Arrays.asList(
				new Transaction(100.0, "Credit", true),
				new Transaction(150.0, "Debit", true),
				new Transaction(200.0, "Credit", false),
				new Transaction(50.0, "Debit", true),
				new Transaction(300.0, "Credit", true));
		
				//List<Transaction> collect = trans.stream().filter(t->t.isSuccess()).collect(Collectors.toList());
